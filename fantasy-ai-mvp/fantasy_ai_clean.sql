...
ALTER TABLE IF EXISTS ONLY public."WageringSettings" DROP CONSTRAINT IF EXISTS "WageringSettings_leagueId_fkey";
ALTER TABLE IF EXISTS ONLY public."Wager" DROP CONSTRAINT IF EXISTS "Wager_winnerId_fkey";
ALTER TABLE IF EXISTS ONLY public."Wager" DROP CONSTRAINT IF EXISTS "Wager_opponentId_fkey";
ALTER TABLE IF EXISTS ONLY public."Wager" DROP CONSTRAINT IF EXISTS "Wager_leagueId_fkey";
ALTER TABLE IF EXISTS ONLY public."Wager" DROP CONSTRAINT IF EXISTS "Wager_escrowId_fkey";
ALTER TABLE IF EXISTS ONLY public."Wager" DROP CONSTRAINT IF EXISTS "Wager_creatorId_fkey";
ALTER TABLE IF EXISTS ONLY public."WagerUpdate" DROP CONSTRAINT IF EXISTS "WagerUpdate_wagerId_fkey";
ALTER TABLE IF EXISTS ONLY public."WagerPlayer" DROP CONSTRAINT IF EXISTS "WagerPlayer_wagerId_fkey";
ALTER TABLE IF EXISTS ONLY public."WagerPlayer" DROP CONSTRAINT IF EXISTS "WagerPlayer_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."ValueSnapshot" DROP CONSTRAINT IF EXISTS "ValueSnapshot_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."UserWallet" DROP CONSTRAINT IF EXISTS "UserWallet_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."UserSubscription" DROP CONSTRAINT IF EXISTS "UserSubscription_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."UserPreferences" DROP CONSTRAINT IF EXISTS "UserPreferences_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."Team" DROP CONSTRAINT IF EXISTS "Team_userId_fkey";
...
ALTER TABLE IF EXISTS ONLY public."Roster" DROP CONSTRAINT IF EXISTS "Roster_teamId_fkey";
ALTER TABLE IF EXISTS ONLY public."Roster" DROP CONSTRAINT IF EXISTS "Roster_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."Reaction" DROP CONSTRAINT IF EXISTS "Reaction_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."Reaction" DROP CONSTRAINT IF EXISTS "Reaction_messageId_fkey";
ALTER TABLE IF EXISTS ONLY public."Reaction" DROP CONSTRAINT IF EXISTS "Reaction_activityId_fkey";
ALTER TABLE IF EXISTS ONLY public."Prediction" DROP CONSTRAINT IF EXISTS "Prediction_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."Prediction" DROP CONSTRAINT IF EXISTS "Prediction_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."Player" DROP CONSTRAINT IF EXISTS "Player_leagueId_fkey";
ALTER TABLE IF EXISTS ONLY public."PlayerPropHistory" DROP CONSTRAINT IF EXISTS "PlayerPropHistory_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."OddsMovement" DROP CONSTRAINT IF EXISTS "OddsMovement_oddsId_fkey";
ALTER TABLE IF EXISTS ONLY public."Notification" DROP CONSTRAINT IF EXISTS "Notification_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."MockDraft" DROP CONSTRAINT IF EXISTS "MockDraft_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."Message" DROP CONSTRAINT IF EXISTS "Message_senderId_fkey";
ALTER TABLE IF EXISTS ONLY public."Message" DROP CONSTRAINT IF EXISTS "Message_recipientId_fkey";
ALTER TABLE IF EXISTS ONLY public."Message" DROP CONSTRAINT IF EXISTS "Message_parentId_fkey";
ALTER TABLE IF EXISTS ONLY public."Message" DROP CONSTRAINT IF EXISTS "Message_leagueId_fkey";
ALTER TABLE IF EXISTS ONLY public."Message" DROP CONSTRAINT IF EXISTS "Message_draftId_fkey";
ALTER TABLE IF EXISTS ONLY public."MemberWageringOptIn" DROP CONSTRAINT IF EXISTS "MemberWageringOptIn_wageringSettingsId_fkey";
ALTER TABLE IF EXISTS ONLY public."MemberWageringOptIn" DROP CONSTRAINT IF EXISTS "MemberWageringOptIn_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."League" DROP CONSTRAINT IF EXISTS "League_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."Friendship" DROP CONSTRAINT IF EXISTS "Friendship_recipientId_fkey";
ALTER TABLE IF EXISTS ONLY public."Friendship" DROP CONSTRAINT IF EXISTS "Friendship_initiatorId_fkey";
ALTER TABLE IF EXISTS ONLY public."EscrowTransaction" DROP CONSTRAINT IF EXISTS "EscrowTransaction_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."EscrowTransaction" DROP CONSTRAINT IF EXISTS "EscrowTransaction_escrowId_fkey";
ALTER TABLE IF EXISTS ONLY public."EscrowAccount" DROP CONSTRAINT IF EXISTS "EscrowAccount_releasedToId_fkey";
ALTER TABLE IF EXISTS ONLY public."Draft" DROP CONSTRAINT IF EXISTS "Draft_leagueId_fkey";
ALTER TABLE IF EXISTS ONLY public."Draft" DROP CONSTRAINT IF EXISTS "Draft_creatorId_fkey";
ALTER TABLE IF EXISTS ONLY public."DraftPick" DROP CONSTRAINT IF EXISTS "DraftPick_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."DraftPick" DROP CONSTRAINT IF EXISTS "DraftPick_participantId_fkey";
ALTER TABLE IF EXISTS ONLY public."DraftPick" DROP CONSTRAINT IF EXISTS "DraftPick_draftId_fkey";
ALTER TABLE IF EXISTS ONLY public."DraftParticipant" DROP CONSTRAINT IF EXISTS "DraftParticipant_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."DraftParticipant" DROP CONSTRAINT IF EXISTS "DraftParticipant_draftId_fkey";
ALTER TABLE IF EXISTS ONLY public."DraftBoard" DROP CONSTRAINT IF EXISTS "DraftBoard_draftId_fkey";
ALTER TABLE IF EXISTS ONLY public."DFSPlayer" DROP CONSTRAINT IF EXISTS "DFSPlayer_contestId_fkey";
ALTER TABLE IF EXISTS ONLY public."DFSLineup" DROP CONSTRAINT IF EXISTS "DFSLineup_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."DFSLineup" DROP CONSTRAINT IF EXISTS "DFSLineup_contestId_fkey";
ALTER TABLE IF EXISTS ONLY public."DFSLineupPlayer" DROP CONSTRAINT IF EXISTS "DFSLineupPlayer_lineupId_fkey";
ALTER TABLE IF EXISTS ONLY public."DFSLineupPlayer" DROP CONSTRAINT IF EXISTS "DFSLineupPlayer_dfsPlayerId_fkey";
ALTER TABLE IF EXISTS ONLY public."ContestResult" DROP CONSTRAINT IF EXISTS "ContestResult_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."ContestResult" DROP CONSTRAINT IF EXISTS "ContestResult_entryId_fkey";
ALTER TABLE IF EXISTS ONLY public."ContestResult" DROP CONSTRAINT IF EXISTS "ContestResult_contestId_fkey";
ALTER TABLE IF EXISTS ONLY public."ContestEntry" DROP CONSTRAINT IF EXISTS "ContestEntry_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."ContestEntry" DROP CONSTRAINT IF EXISTS "ContestEntry_lineupId_fkey";
ALTER TABLE IF EXISTS ONLY public."ContestEntry" DROP CONSTRAINT IF EXISTS "ContestEntry_contestId_fkey";
ALTER TABLE IF EXISTS ONLY public."Bounty" DROP CONSTRAINT IF EXISTS "Bounty_winnerId_fkey";
ALTER TABLE IF EXISTS ONLY public."Bounty" DROP CONSTRAINT IF EXISTS "Bounty_leagueId_fkey";
ALTER TABLE IF EXISTS ONLY public."Bounty" DROP CONSTRAINT IF EXISTS "Bounty_escrowId_fkey";
ALTER TABLE IF EXISTS ONLY public."Bounty" DROP CONSTRAINT IF EXISTS "Bounty_creatorId_fkey";
ALTER TABLE IF EXISTS ONLY public."BountyUpdate" DROP CONSTRAINT IF EXISTS "BountyUpdate_bountyId_fkey";
ALTER TABLE IF EXISTS ONLY public."BountyParticipant" DROP CONSTRAINT IF EXISTS "BountyParticipant_participantId_fkey";
ALTER TABLE IF EXISTS ONLY public."BountyParticipant" DROP CONSTRAINT IF EXISTS "BountyParticipant_bountyId_fkey";
ALTER TABLE IF EXISTS ONLY public."BettingSlip" DROP CONSTRAINT IF EXISTS "BettingSlip_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."BettingSelection" DROP CONSTRAINT IF EXISTS "BettingSelection_oddsId_fkey";
ALTER TABLE IF EXISTS ONLY public."BettingSelection" DROP CONSTRAINT IF EXISTS "BettingSelection_bettingSlipId_fkey";
ALTER TABLE IF EXISTS ONLY public."BettingOdds" DROP CONSTRAINT IF EXISTS "BettingOdds_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."BettingInsight" DROP CONSTRAINT IF EXISTS "BettingInsight_playerId_fkey";
ALTER TABLE IF EXISTS ONLY public."Alert" DROP CONSTRAINT IF EXISTS "Alert_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."ActivityItem" DROP CONSTRAINT IF EXISTS "ActivityItem_userId_fkey";
ALTER TABLE IF EXISTS ONLY public."ActivityItem" DROP CONSTRAINT IF EXISTS "ActivityItem_leagueId_fkey";
DROP INDEX IF EXISTS public."WageringSettings_leagueId_key";
DROP INDEX IF EXISTS public."Wager_type_idx";
DROP INDEX IF EXISTS public."Wager_status_idx";
DROP INDEX IF EXISTS public."Wager_opponentId_idx";
DROP INDEX IF EXISTS public."Wager_escrowId_key";
DROP INDEX IF EXISTS public."Wager_creatorId_idx";
DROP INDEX IF EXISTS public."WagerUpdate_wagerId_idx";
DROP INDEX IF EXISTS public."WagerUpdate_type_idx";
DROP INDEX IF EXISTS public."WagerPlayer_wagerId_playerId_side_key";
DROP INDEX IF EXISTS public."ValueSnapshot_timestamp_idx";
DROP INDEX IF EXISTS public."ValueSnapshot_playerId_idx";
DROP INDEX IF EXISTS public."User_email_key";
DROP INDEX IF EXISTS public."UserWallet_userId_key";
DROP INDEX IF EXISTS public."UserSubscription_userId_idx";
DROP INDEX IF EXISTS public."UserPreferences_userId_key";
DROP INDEX IF EXISTS public."Subscription_userId_key";
DROP INDEX IF EXISTS public."Roster_teamId_playerId_week_key";
DROP INDEX IF EXISTS public."Reaction_userId_messageId_reactionType_key";
DROP INDEX IF EXISTS public."Reaction_userId_activityId_reactionType_key";
DROP INDEX IF EXISTS public."Reaction_messageId_idx";
DROP INDEX IF EXISTS public."Reaction_activityId_idx";
DROP INDEX IF EXISTS public."Player_externalId_leagueId_key";
DROP INDEX IF EXISTS public."PlayerPropHistory_propType_idx";
DROP INDEX IF EXISTS public."PlayerPropHistory_playerId_idx";
DROP INDEX IF EXISTS public."PlayerPropHistory_gameDate_idx";
DROP INDEX IF EXISTS public."OddsMovement_timestamp_idx";
DROP INDEX IF EXISTS public."OddsMovement_oddsId_idx";
...
DROP INDEX IF EXISTS public."MockDraft_userId_idx";
DROP INDEX IF EXISTS public."MockDraft_sport_idx";
DROP INDEX IF EXISTS public."Message_senderId_idx";
DROP INDEX IF EXISTS public."Message_leagueId_idx";
DROP INDEX IF EXISTS public."Message_draftId_idx";
DROP INDEX IF EXISTS public."Message_createdAt_idx";
DROP INDEX IF EXISTS public."MemberWageringOptIn_userId_wageringSettingsId_key";
DROP INDEX IF EXISTS public."League_provider_providerId_key";
DROP INDEX IF EXISTS public."Friendship_status_idx";
DROP INDEX IF EXISTS public."Friendship_recipientId_idx";
DROP INDEX IF EXISTS public."Friendship_initiatorId_recipientId_key";
DROP INDEX IF EXISTS public."Friendship_initiatorId_idx";
DROP INDEX IF EXISTS public."EscrowTransaction_userId_idx";
DROP INDEX IF EXISTS public."EscrowTransaction_type_idx";
DROP INDEX IF EXISTS public."EscrowTransaction_status_idx";
DROP INDEX IF EXISTS public."EscrowAccount_status_idx";
DROP INDEX IF EXISTS public."Draft_status_idx";
DROP INDEX IF EXISTS public."Draft_sport_idx";
DROP INDEX IF EXISTS public."Draft_scheduledStart_idx";
DROP INDEX IF EXISTS public."Draft_draftType_idx";
DROP INDEX IF EXISTS public."DraftPick_userId_idx";
DROP INDEX IF EXISTS public."DraftPick_participantId_idx";
DROP INDEX IF EXISTS public."DraftPick_draftId_round_pickInRound_key";
DROP INDEX IF EXISTS public."DraftPick_draftId_idx";
DROP INDEX IF EXISTS public."DraftParticipant_userId_idx";
DROP INDEX IF EXISTS public."DraftParticipant_draftId_userId_key";
DROP INDEX IF EXISTS public."DraftParticipant_draftId_idx";
DROP INDEX IF EXISTS public."DraftParticipant_draftId_draftPosition_key";
DROP INDEX IF EXISTS public."DraftBoard_draftId_key";
DROP INDEX IF EXISTS public."DraftBoard_draftId_idx";
DROP INDEX IF EXISTS public."DFSPlayer_salary_idx";
DROP INDEX IF EXISTS public."DFSPlayer_projectedPoints_idx";
DROP INDEX IF EXISTS public."DFSPlayer_position_idx";
DROP INDEX IF EXISTS public."DFSPlayer_contestId_idx";
DROP INDEX IF EXISTS public."DFSPlayer_contestId_externalPlayerId_key";
DROP INDEX IF EXISTS public."DFSLineup_userId_idx";
DROP INDEX IF EXISTS public."DFSLineup_totalPoints_idx";
DROP INDEX IF EXISTS public."DFSLineup_contestId_idx";
DROP INDEX IF EXISTS public."DFSLineupPlayer_lineupId_slotPosition_key";
DROP INDEX IF EXISTS public."DFSLineupPlayer_lineupId_idx";
DROP INDEX IF EXISTS public."DFSLineupPlayer_dfsPlayerId_idx";
DROP INDEX IF EXISTS public."Contest_status_idx";
DROP INDEX IF EXISTS public."Contest_startTime_idx";
DROP INDEX IF EXISTS public."Contest_sport_idx";
DROP INDEX IF EXISTS public."Contest_contestType_idx";
DROP INDEX IF EXISTS public."ContestResult_userId_idx";
DROP INDEX IF EXISTS public."ContestResult_finalRank_idx";
DROP INDEX IF EXISTS public."ContestResult_contestId_idx";
DROP INDEX IF EXISTS public."ContestResult_contestId_entryId_key";
DROP INDEX IF EXISTS public."ContestEntry_userId_idx";
DROP INDEX IF EXISTS public."ContestEntry_totalPoints_idx";
DROP INDEX IF EXISTS public."ContestEntry_lineupId_key";
DROP INDEX IF EXISTS public."ContestEntry_contestId_userId_entryNumber_key";
DROP INDEX IF EXISTS public."ContestEntry_contestId_idx";
DROP INDEX IF EXISTS public."Bounty_status_idx";
DROP INDEX IF EXISTS public."Bounty_escrowId_key";
DROP INDEX IF EXISTS public."Bounty_creatorId_idx";
DROP INDEX IF EXISTS public."Bounty_bountyAmount_idx";
DROP INDEX IF EXISTS public."BountyUpdate_type_idx";
DROP INDEX IF EXISTS public."BountyUpdate_bountyId_idx";
DROP INDEX IF EXISTS public."BountyParticipant_participantId_idx";
DROP INDEX IF EXISTS public."BountyParticipant_bountyId_participantId_key";
DROP INDEX IF EXISTS public."BettingSlip_userId_idx";
DROP INDEX IF EXISTS public."BettingSlip_status_idx";
DROP INDEX IF EXISTS public."BettingSlip_placedAt_idx";
DROP INDEX IF EXISTS public."BettingSelection_oddsId_idx";
DROP INDEX IF EXISTS public."BettingSelection_bettingSlipId_idx";
DROP INDEX IF EXISTS public."BettingOdds_propType_idx";
DROP INDEX IF EXISTS public."BettingOdds_playerId_idx";
DROP INDEX IF EXISTS public."BettingOdds_isLive_idx";
DROP INDEX IF EXISTS public."BettingOdds_gameId_idx";
DROP INDEX IF EXISTS public."BettingInsight_propType_idx";
DROP INDEX IF EXISTS public."BettingInsight_playerId_idx";
DROP INDEX IF EXISTS public."BettingInsight_expiresAt_idx";
DROP INDEX IF EXISTS public."BettingInsight_confidence_idx";
DROP INDEX IF EXISTS public."ActivityItem_userId_idx";
DROP INDEX IF EXISTS public."ActivityItem_leagueId_idx";
DROP INDEX IF EXISTS public."ActivityItem_createdAt_idx";
DROP INDEX IF EXISTS public."ActivityItem_activityType_idx";
ALTER TABLE IF EXISTS ONLY public.subscription_usage DROP CONSTRAINT IF EXISTS subscription_usage_pkey;
ALTER TABLE IF EXISTS ONLY public."WageringSettings" DROP CONSTRAINT IF EXISTS "WageringSettings_pkey";
ALTER TABLE IF EXISTS ONLY public."Wager" DROP CONSTRAINT IF EXISTS "Wager_pkey";
ALTER TABLE IF EXISTS ONLY public."WagerUpdate" DROP CONSTRAINT IF EXISTS "WagerUpdate_pkey";
ALTER TABLE IF EXISTS ONLY public."WagerPlayer" DROP CONSTRAINT IF EXISTS "WagerPlayer_pkey";
ALTER TABLE IF EXISTS ONLY public."ValueSnapshot" DROP CONSTRAINT IF EXISTS "ValueSnapshot_pkey";
ALTER TABLE IF EXISTS ONLY public."User" DROP CONSTRAINT IF EXISTS "User_pkey";
ALTER TABLE IF EXISTS ONLY public."UserWallet" DROP CONSTRAINT IF EXISTS "UserWallet_pkey";
ALTER TABLE IF EXISTS ONLY public."UserSubscription" DROP CONSTRAINT IF EXISTS "UserSubscription_pkey";
...
ALTER TABLE IF EXISTS ONLY public."PlayerPropHistory" DROP CONSTRAINT IF EXISTS "PlayerPropHistory_pkey";
ALTER TABLE IF EXISTS ONLY public."OddsMovement" DROP CONSTRAINT IF EXISTS "OddsMovement_pkey";
ALTER TABLE IF EXISTS ONLY public."Notification" DROP CONSTRAINT IF EXISTS "Notification_pkey";
ALTER TABLE IF EXISTS ONLY public."MockDraft" DROP CONSTRAINT IF EXISTS "MockDraft_pkey";
ALTER TABLE IF EXISTS ONLY public."Message" DROP CONSTRAINT IF EXISTS "Message_pkey";
ALTER TABLE IF EXISTS ONLY public."MemberWageringOptIn" DROP CONSTRAINT IF EXISTS "MemberWageringOptIn_pkey";
...
ALTER TABLE IF EXISTS ONLY public."EscrowAccount" DROP CONSTRAINT IF EXISTS "EscrowAccount_pkey";
ALTER TABLE IF EXISTS ONLY public."Draft" DROP CONSTRAINT IF EXISTS "Draft_pkey";
ALTER TABLE IF EXISTS ONLY public."DraftPick" DROP CONSTRAINT IF EXISTS "DraftPick_pkey";
ALTER TABLE IF EXISTS ONLY public."DraftParticipant" DROP CONSTRAINT IF EXISTS "DraftParticipant_pkey";
ALTER TABLE IF EXISTS ONLY public."DraftBoard" DROP CONSTRAINT IF EXISTS "DraftBoard_pkey";
ALTER TABLE IF EXISTS ONLY public."DFSPlayer" DROP CONSTRAINT IF EXISTS "DFSPlayer_pkey";
ALTER TABLE IF EXISTS ONLY public."DFSLineup" DROP CONSTRAINT IF EXISTS "DFSLineup_pkey";
ALTER TABLE IF EXISTS ONLY public."DFSLineupPlayer" DROP CONSTRAINT IF EXISTS "DFSLineupPlayer_pkey";
ALTER TABLE IF EXISTS ONLY public."Contest" DROP CONSTRAINT IF EXISTS "Contest_pkey";
ALTER TABLE IF EXISTS ONLY public."ContestResult" DROP CONSTRAINT IF EXISTS "ContestResult_pkey";
ALTER TABLE IF EXISTS ONLY public."ContestEntry" DROP CONSTRAINT IF EXISTS "ContestEntry_pkey";
ALTER TABLE IF EXISTS ONLY public."Bounty" DROP CONSTRAINT IF EXISTS "Bounty_pkey";
ALTER TABLE IF EXISTS ONLY public."BountyUpdate" DROP CONSTRAINT IF EXISTS "BountyUpdate_pkey";
ALTER TABLE IF EXISTS ONLY public."BountyParticipant" DROP CONSTRAINT IF EXISTS "BountyParticipant_pkey";
ALTER TABLE IF EXISTS ONLY public."BettingSlip" DROP CONSTRAINT IF EXISTS "BettingSlip_pkey";
ALTER TABLE IF EXISTS ONLY public."BettingSelection" DROP CONSTRAINT IF EXISTS "BettingSelection_pkey";
ALTER TABLE IF EXISTS ONLY public."BettingOdds" DROP CONSTRAINT IF EXISTS "BettingOdds_pkey";
ALTER TABLE IF EXISTS ONLY public."BettingInsight" DROP CONSTRAINT IF EXISTS "BettingInsight_pkey";
ALTER TABLE IF EXISTS ONLY public."Alert" DROP CONSTRAINT IF EXISTS "Alert_pkey";
ALTER TABLE IF EXISTS ONLY public."ActivityItem" DROP CONSTRAINT IF EXISTS "ActivityItem_pkey";
DROP TABLE IF EXISTS public.subscription_usage;
DROP TABLE IF EXISTS public."WageringSettings";
DROP TABLE IF EXISTS public."WagerUpdate";
DROP TABLE IF EXISTS public."WagerPlayer";
DROP TABLE IF EXISTS public."Wager";
DROP TABLE IF EXISTS public."ValueSnapshot";
DROP TABLE IF EXISTS public."UserWallet";
DROP TABLE IF EXISTS public."UserSubscription";
...
DROP TABLE IF EXISTS public."PlayerPropHistory";
DROP TABLE IF EXISTS public."Player";
DROP TABLE IF EXISTS public."OddsMovement";
DROP TABLE IF EXISTS public."Notification";
DROP TABLE IF EXISTS public."MockDraft";
DROP TABLE IF EXISTS public."Message";
DROP TABLE IF EXISTS public."MemberWageringOptIn";
DROP TABLE IF EXISTS public."League";
DROP TABLE IF EXISTS public."Friendship";
DROP TABLE IF EXISTS public."EscrowTransaction";
DROP TABLE IF EXISTS public."EscrowAccount";
DROP TABLE IF EXISTS public."DraftPick";
DROP TABLE IF EXISTS public."DraftParticipant";
DROP TABLE IF EXISTS public."DraftBoard";
DROP TABLE IF EXISTS public."Draft";
DROP TABLE IF EXISTS public."DFSPlayer";
DROP TABLE IF EXISTS public."DFSLineupPlayer";
DROP TABLE IF EXISTS public."DFSLineup";
DROP TABLE IF EXISTS public."ContestResult";
DROP TABLE IF EXISTS public."ContestEntry";
DROP TABLE IF EXISTS public."Contest";
DROP TABLE IF EXISTS public."BountyUpdate";
DROP TABLE IF EXISTS public."BountyParticipant";
DROP TABLE IF EXISTS public."Bounty";
DROP TABLE IF EXISTS public."BettingSlip";
DROP TABLE IF EXISTS public."BettingSelection";
DROP TABLE IF EXISTS public."BettingOdds";
DROP TABLE IF EXISTS public."BettingInsight";
DROP TABLE IF EXISTS public."Alert";
DROP TABLE IF EXISTS public."ActivityItem";
DROP TYPE IF EXISTS public."WagerType";
DROP TYPE IF EXISTS public."WagerTimeframe";
DROP TYPE IF EXISTS public."WagerStatus";
DROP TYPE IF EXISTS public."WagerSide";
DROP TYPE IF EXISTS public."UpdateType";
...
DROP TYPE IF EXISTS public."PropType";
...
DROP TYPE IF EXISTS public."InsightRecommendation";
DROP TYPE IF EXISTS public."FriendshipStatus";
DROP TYPE IF EXISTS public."FantasyProvider";
DROP TYPE IF EXISTS public."EscrowStatus";
DROP TYPE IF EXISTS public."DraftType";
DROP TYPE IF EXISTS public."DraftStatus";
DROP TYPE IF EXISTS public."DraftOrder";
DROP TYPE IF EXISTS public."ContestType";
DROP TYPE IF EXISTS public."ContestStatus";
DROP TYPE IF EXISTS public."BountyStatus";
DROP TYPE IF EXISTS public."BillingInterval";
DROP TYPE IF EXISTS public."BettingSlipStatus";
DROP TYPE IF EXISTS public."BetSelection";
